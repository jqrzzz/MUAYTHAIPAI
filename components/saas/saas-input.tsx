...
export const saasFieldClass =
  "w-full bg-zinc-950/50 ring-1 ring-zinc-800 focus:ring-indigo-500/40 rounded-lg px-3 py-2 text-[13px] text-zinc-100 placeholder:text-zinc-600 outline-none transition-shadow disabled:opacity-50"
