        ...
        <Card className="bg-orange-600/20 border-orange-500/30">
          <CardContent className="p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              {gym.whatsapp && (
                <a href={`https://wa.me/${gym.whatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer">
                  <Button className="bg-green-600 hover:bg-green-500 w-full sm:w-auto">WhatsApp Us</Button>
                </a>
              )}
              <Link href={`/book?gym=${gym.slug}`}>
                <Button className="bg-orange-600 hover:bg-orange-500 w-full sm:w-auto">Book Now</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
