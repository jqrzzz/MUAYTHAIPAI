                  ...
                  {filteredPosts.map((post, index) => (
                    ...
                    >
                      <Accordion type="single" collapsible className="w-full">
                        ...
                        >
                          <AccordionTrigger
                            className="px-6 py-4 text-left hover:no-underline transition-colors text-amber-900 data-[state=open]:bg-orange-500/10 dark:text-amber-700 dark:data-[state=open]:bg-orange-500/20"
                          >
                            <div className="flex flex-col items-start w-full">
                              <div className="flex items-center justify-between w-full mb-2">
                                <span
                                  className="text-xs font-medium px-2 py-1 rounded-full bg-orange-200/60 text-orange-700 dark:bg-orange-500/20 dark:text-orange-300"
                                >
                                  {post.category}
                                </span>
